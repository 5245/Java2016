...
public class QRCodeUtil {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress, String fileName) throws Exception {
        ...
        // 插入图片  
        QRCodeUtil.insertImage(image, imgPath, needCompress, fileName);
        return image;
    }
    ...
    public static void encode(String content, String imgPath, String destPath, boolean needCompress, String fileName) throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, imgPath, needCompress, fileName);
        mkdirs(destPath);
     ...
     * @throws Exception 
     */
    public static void encode(String content, OutputStream output, String fileName) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        QRCodeUtil.encode(text, "D:/logo3.jpg", "D:/a_back", true, "aa.png");
    }
}
