...
public class HttpUtility {
    ...
    public static String post(String url, Map<String, String> params, Map<String, String> headers, String charset, int timeout) {
        return post(url, params, headers, charset, timeout, false);
    }

    public static String post(String url, Map<String, String> params, Map<String, String> headers, String charset, int timeout, boolean gzip) {
        ...
        if (gzip) {
            ...
            try {
                ...
                //String message = JSONObject.fromObject(params).toString();
                String message = JSONObject.toJSONString(params);
                originalContent.write(message.getBytes(Charset.forName(charset)));
                ...
                method.setRequestEntity(new ByteArrayRequestEntity(baos.toByteArray(), "text/plain; charset=" + charset));
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
