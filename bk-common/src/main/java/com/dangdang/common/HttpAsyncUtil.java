...
public class HttpAsyncUtil {
    ...
    public static String upload(String url, Map<String, String> params, Map<String, String> headers, Map<String, File> files, String charset, int timeout) {
    ...
    private static HttpResponse upload2Response(String url, Map<String, String> params, Map<String, String> headers, Map<String, File> files, String charset, int timeout) {
        if (!verifyUrl(url)) {
            return null;
        }
        HttpPost httpPost = new HttpPost(url);
