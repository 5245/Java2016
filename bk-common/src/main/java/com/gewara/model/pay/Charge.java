...
//import com.gewara.cons.ChargeConstant;
...
public class Charge extends BaseObject{
	...
	public static final List<String> FORBIDDEN_INVOICE_LIST = Arrays.asList("PaymethodConstant.PAYMETHOD_SYSPAY", "PaymethodConstant.PAYMETHOD_CHARGECARD");
	...
	private Long fromMemberid;		//谁给当前用户充值
	...
	public boolean isCanInvoice(){
		return status.equals(STATUS_PAID) && StringUtils.equals(chargeto, "ChargeConstant.WABIPAY") && !FORBIDDEN_INVOICE_LIST.contains(paymethod);
	}
