...
public class ImageWatermarkTest {
    ...
    private synchronized void watermarkImg(String srcPath, String distPath, String watermarkImg, int width, int height, int x, int y, int alpha) throws IOException, InterruptedException, IM4JavaException {
        ...
        //   String path = "D:\\ProgramFiles\\GraphicsMagick-1.3.21-Q8";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String src = "D:\\a.jpg"; //需要加水印的源图片  
            String desc = "D:\\a_watermark.jpg"; //生成的水印图片的路径  
            String water = "D:\\water.png"; //用中文转换成的背景透明的png图片  
            //String fontType = "C:\\Windows\\Fonts\\simsun.ttc"; //指定字体文件为宋体  
            //String fontType = "宋体"; //指定字体文件为宋体  、方正舒体、华文彩云、楷体、幼圆、微软雅黑、隶书
            String fontType = "楷体"; //指定字体文件为宋体  
            String colorStr = "990033"; //颜色  
            int fontSize = 20;

            ImageWatermarkTest watermark = new ImageWatermarkTest();
             ...
             * @throws Exception 
             */
    //        watermark.converFontToImage("赵丽颖", fontType, fontSize, colorStr, water);
            /* 
             * 把文字的png图片贴在原图上，生成水印 
             * @param srcPath       原图片路径 
             * @param distPath      新图片路径 
